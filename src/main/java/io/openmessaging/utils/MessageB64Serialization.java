...
public class MessageB64Serialization {
    static int FIXED_PART_LEN = 10;  // assume FIXED_PART_LEN >=2, otherwise program is not correct
    static int BASE64_INFO_LEN = 2;
    static int INDEX_LEN = 4;
    static int VARYING_VERIFY_LEN = 4;
    static int COPY_PART_LEN = FIXED_PART_LEN - INDEX_LEN;

    static byte[] magicArr = {'B', 'L', 'I', 'N', 'K'};
    static int MAX_FIVE_BITS_INT = 0x1f;      // 31, for varyingLen Serialization
